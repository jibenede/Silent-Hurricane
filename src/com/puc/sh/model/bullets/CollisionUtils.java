...
public class CollisionUtils {
    ...
    public static boolean playerBulletCollide(Player player,
    ...
    public static boolean circleCollide(float c1_x, float c1_y, float c1_r,
            float c2_x, float c2_y, float c2_r) {
        return (c1_x - c2_x) * (c1_x - c2_x) + (c1_y - c2_y) * (c1_y - c2_y) < (c1_r + c2_r)
                * (c1_r + c2_r);
    }

    public static boolean rectCollide(float r1_top, float r1_right,
            float r1_bottom, float r1_left, float r2_top, float r2_right,
            float r2_bottom, float r2_left) {
